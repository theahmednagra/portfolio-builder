    ...
    <div className="min-h-screen bg-[#030303] text-portfolio-text selection:bg-portfolio-accent/20 selection:text-portfolio-accent overflow-x-hidden antialiased">
      ...
      <section className="px-6 sm:px-12 max-w-5xl mx-auto pb-24 border-t border-portfolio-border/20 pt-12 md:pt-16">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          {/* Feature 1 */}
          <div className="flex flex-col space-y-3.5 p-5 rounded-2xl border border-portfolio-border/30 bg-portfolio-card/10">
            <div className="w-9 h-9 rounded-lg border border-portfolio-border/60 bg-portfolio-card flex items-center justify-center text-portfolio-accent">
              <FiLayers className="w-4 h-4" />
            </div>
            <h3 className="text-[15px] font-bold tracking-tight text-portfolio-text">Obsidian Custom Engine</h3>
            <p className="text-[13px] text-portfolio-muted/70 leading-relaxed font-medium">
              Create gorgeous dark-themed modern layouts optimized dynamically with zero performance drops.
            </p>
          </div>
          ...
          <div className="flex flex-col space-y-3.5 p-5 rounded-2xl border border-portfolio-border/30 bg-portfolio-card/10">
            ...
            <h3 className="text-[15px] font-bold tracking-tight text-portfolio-text">Live Interactive Analytics</h3>
            <p className="text-[13px] text-portfolio-muted/70 leading-relaxed font-medium">
              Track global engineering audience interactions and click behaviors through integrated metrics streams.
            </p>
          </div>
          ...
          <div className="flex flex-col space-y-3.5 p-5 rounded-2xl border border-portfolio-border/30 bg-portfolio-card/10">
            ...
            <h3 className="text-[15px] font-bold tracking-tight text-portfolio-text">Optimized Asset Delivery</h3>
            <p className="text-[13px] text-portfolio-muted/70 leading-relaxed font-medium">
              Lightweight processing pipelines keep your images crisp and fluid with responsive fallback transitions.
            </p>
          </div>
